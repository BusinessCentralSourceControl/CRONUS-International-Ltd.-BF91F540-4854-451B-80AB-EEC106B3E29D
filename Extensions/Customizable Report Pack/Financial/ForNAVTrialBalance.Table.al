Table 6188677 "ForNAV Trial Balance"
{
    fields
    {
        ...
        field(21; "Print Amount 1"; Text[30]) { Caption = 'Print Amount 1', Comment = 'DO NOT TRANSLATE'; CaptionClass = GetCaptionClass(1); DataClassification = SystemMetadata; }
        field(22; "Print Amount 2"; Text[30]) { Caption = 'Print Amount 2', Comment = 'DO NOT TRANSLATE'; CaptionClass = GetCaptionClass(2); DataClassification = SystemMetadata; }
        field(23; "Print Amount 3"; Text[30]) { Caption = 'Print Amount 3', Comment = 'DO NOT TRANSLATE'; CaptionClass = GetCaptionClass(3); DataClassification = SystemMetadata; }
        field(24; "Print Amount 4"; Text[30]) { Caption = 'Print Amount 4', Comment = 'DO NOT TRANSLATE'; CaptionClass = GetCaptionClass(4); DataClassification = SystemMetadata; }
        field(25; "Print Amount 5"; Text[30]) { Caption = 'Print Amount 5', Comment = 'DO NOT TRANSLATE'; CaptionClass = GetCaptionClass(5); DataClassification = SystemMetadata; }
        field(26; "Print Amount 6"; Text[30]) { Caption = 'Print Amount 6', Comment = 'DO NOT TRANSLATE'; CaptionClass = GetCaptionClass(6); DataClassification = SystemMetadata; }
        field(27; "Print Amount 7"; Text[30]) { Caption = 'Print Amount 7', Comment = 'DO NOT TRANSLATE'; CaptionClass = GetCaptionClass(7); DataClassification = SystemMetadata; }
        field(28; "Print Amount 8"; Text[30]) { Caption = 'Print Amount 8', Comment = 'DO NOT TRANSLATE'; CaptionClass = GetCaptionClass(8); DataClassification = SystemMetadata; }
        field(31; RoundTo; Option) { Caption = 'RountTo', Comment = 'DO NOT TRANSLATE'; DataClassification = SystemMetadata; OptionMembers = Pennies,Dollars,Thousands; }
        ...
        field(102; "Caption 1"; Text[80]) { Caption = 'Caption 1', Comment = 'DO NOT TRANSLATE'; DataClassification = SystemMetadata; }
        field(103; "Caption 2"; Text[80]) { Caption = 'Caption 2', Comment = 'DO NOT TRANSLATE'; DataClassification = SystemMetadata; }
        field(104; "Caption 3"; Text[80]) { Caption = 'Caption 3', Comment = 'DO NOT TRANSLATE'; DataClassification = SystemMetadata; }
        field(105; "Caption 4"; Text[80]) { Caption = 'Caption 4', Comment = 'DO NOT TRANSLATE'; DataClassification = SystemMetadata; }
        field(106; "Caption 5"; Text[80]) { Caption = 'Caption 5', Comment = 'DO NOT TRANSLATE'; DataClassification = SystemMetadata; }
        field(107; "Caption 6"; Text[80]) { Caption = 'Caption 6', Comment = 'DO NOT TRANSLATE'; DataClassification = SystemMetadata; }
        field(108; "Caption 7"; Text[80]) { Caption = 'Caption 7', Comment = 'DO NOT TRANSLATE'; DataClassification = SystemMetadata; }
        field(109; "Caption 8"; Text[80]) { Caption = 'Caption 8', Comment = 'DO NOT TRANSLATE'; DataClassification = SystemMetadata; }
    }
    ...
    local procedure RoundAmounts(Value: Decimal; Args: Record "ForNAV Trial Balance Args."): Text
    begin
        case Args."Rounding Factor" of
            Args."rounding factor"::None:
                exit(Format(ROUND(Value, 0.01), 0, '<Precision,2:2><Standard Format,0>'));
            Args."rounding factor"::"1":
                exit(Format(ROUND(Value, 1)));
            Args."rounding factor"::"1000":
                exit(Format(ROUND(Value / 1000, 1)));
            Args."rounding factor"::"1000000":
                exit(Format(ROUND(Value / 10000000, 0.01)));
        end;
    end;
    ...
    local procedure FormatAsNumber(Args: Record "ForNAV Trial Balance Args."; Value: Decimal): Text
    begin
        if Value = 0 then
            exit('');
