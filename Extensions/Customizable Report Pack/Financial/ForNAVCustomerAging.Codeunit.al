Codeunit 6188691 "ForNAV Customer Aging"
{
    ...
    begin
        ...
        if DetailedCustLedgEntry.FindSet then
            repeat
                if CustLedgEntry.Get(DetailedCustLedgEntry."Cust. Ledger Entry No.") then
        ...
        if TempCustLedgEntry.FindSet then
            repeat
                ...
                if not Args."Print Amounts in LCY" then
                    AgingBuffer."Currency Code" := AgingCalculation.GetCurrencyCode(TempCustLedgEntry."Currency Code");
                ...
                AgingBuffer."Document Type" := TempCustLedgEntry."Document Type".AsInteger();
