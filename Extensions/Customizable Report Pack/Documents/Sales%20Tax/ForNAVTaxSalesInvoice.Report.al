...
{	
	...
	{
		type(ForNav.Report_6_0_0_2078; ForNavReport6188522_v6_0_0_2078){}   
	}
...
{
	Caption = 'Invoice';
	RDLCLayout = './Layouts/ForNAV Tax Sales Invoice.rdlc'; DefaultLayout = RDLC;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport6188522_v6_0_0_2078;
