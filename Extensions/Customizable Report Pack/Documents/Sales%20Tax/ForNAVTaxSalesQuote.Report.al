...
{	
	...
	{
		type(ForNav.Report_6_0_0_2078; ForNavReport6188525_v6_0_0_2078){}   
	}
...
{
	Caption = 'Quote';
	RDLCLayout = './Layouts/ForNAV Tax Sales Quote.rdlc'; DefaultLayout = RDLC;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport6188525_v6_0_0_2078;
