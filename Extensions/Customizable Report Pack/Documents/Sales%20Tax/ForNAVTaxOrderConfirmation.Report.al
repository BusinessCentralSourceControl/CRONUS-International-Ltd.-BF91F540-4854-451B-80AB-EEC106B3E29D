...
{	
	...
	{
		type(ForNav.Report_6_0_0_2078; ForNavReport6188521_v6_0_0_2078){}   
	}
...
{
	Caption = 'Order';
	RDLCLayout = './Layouts/ForNAV Tax Order Confirmation.rdlc'; DefaultLayout = RDLC;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport6188521_v6_0_0_2078;
