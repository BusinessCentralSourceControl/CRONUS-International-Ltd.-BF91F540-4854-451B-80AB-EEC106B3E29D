...
{	
	...
	{
		type(ForNav.Report_6_0_0_2078; ForNavReport6188523_v6_0_0_2078){}   
	}
...
{
	Caption = 'Credit Memo';
	RDLCLayout = './Layouts/ForNAV Tax Credit Memo.rdlc'; DefaultLayout = RDLC;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport6188523_v6_0_0_2078;
