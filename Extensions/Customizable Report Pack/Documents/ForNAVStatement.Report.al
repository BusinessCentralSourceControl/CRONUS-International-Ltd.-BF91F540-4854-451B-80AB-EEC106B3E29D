...
{	
	...
	{
		type(ForNav.Report_6_0_0_2078; ForNavReport6188721_v6_0_0_2078){}   
	}
...
Report 6188721 "ForNAV Statement"
{
	...
	RDLCLayout = './Layouts/ForNAV Statement.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		...
		dataitem(Customer;Customer)
		{
			...
			dataitem(CurrencyLoop;Currency)
			{
				...
				column(ReportForNavId_6523; 6523) {} // Autogenerated by ForNav - Do not delete
				...
				dataitem(OverdueEntry;"Cust. Ledger Entry")
				{
					...
					column(ReportForNavId_9065; 9065) {} // Autogenerated by ForNav - Do not delete
					trigger OnPreDataItem();
					begin
						SetRange("Customer No.", Customer."No.");
	...
	begin
		if (not Args."Print All Having Entries") and (not Args."Print All Having Balance") then
			Args."Print All Having Balance" := true;
		if Format(Args."Period Length") = '' then
			Evaluate(Args."Period Length", '<1M+CM>');
		if Args."Document Date" = 0D then
			Args."Document Date" := Today;
		if Args."Start Date" = 0D then
			Args."Start Date" := WorkDate;
	...
	procedure InitializeRequest(NewPrintEntriesDue: Boolean; NewPrintAllHavingEntry: Boolean; NewPrintAllHavingBal: Boolean; NewIncludeAgingBand: Boolean; NewPeriodLength: Text[30]; NewDateChoice: Option "Due Date","Posting Date"; NewStartDate: Date; NewEndDate: Date)
	begin
		InitRequestPageDataInternal();
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport6188721_v6_0_0_2078;
