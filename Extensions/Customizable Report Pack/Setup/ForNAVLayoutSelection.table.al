table 6188503 "ForNAV Layout Selection"
{
    ...
    fields
    {
        ...
        field(5; "Table No."; Integer) { Caption = 'Table No.'; DataClassification = SystemMetadata; }
        ...
        field(9; "Value"; Code[50]) { Caption = 'Value'; DataClassification = CustomerContent; }

    }

    keys { key(PK; "Report ID", "Custom Report Layout Code", "Table No.", "Field No.") { Clustered = true; } }
}