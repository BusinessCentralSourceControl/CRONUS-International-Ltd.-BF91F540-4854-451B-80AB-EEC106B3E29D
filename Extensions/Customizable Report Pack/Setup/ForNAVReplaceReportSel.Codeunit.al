Codeunit 6188500 "ForNAV Replace Report Sel."
{
    trigger OnRun()
    var
        DefaultReportSelection: Record "ForNAV Report Selection Hist." temporary;
    begin
    ...
    procedure GetDefaults(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    var
        Dlg: Dialog;
    begin
        Dlg.Open('#1#####################################');
    ...
    local procedure Replace(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    var
        ...
        Usge: Integer;
    begin
        if DefaultReportSelection.FindSet then
            repeat
                if DefaultReportSelection.Origin = 77 then
                    Usge := DefaultReportSelection.Usage
                else
                ...
                if AllObj.FindFirst then begin
                    ...
                    if RecRef.FindSet then
                        repeat
                            SaveHistory(DefaultReportSelection.Origin, Usge, RecRef.Field(3).Value, RecRef.Field(2).Value);
                        until RecRef.Next = 0;
    ...
    local procedure ReplaceSalesOrderConfirmation(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceSalesInvoice(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceProFormaInvoice(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceDraftInvoice(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceSalesCreditMemo(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceSalesShipment(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceSalesQuote(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplacePickList(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplacePurchaseOrder(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplacePurchaseQuote(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplacePurchaseInvoice(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplacePurchaseCreditMemo(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceCheck(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceStatement(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceReminder(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceReminderTest(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceFinanceChargeMemo(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceFinanceChargeMemoTest(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceServiceOrder(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceServiceInvoice(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceServiceCreditMemo(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceServiceShipment(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceServiceQuote(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceWarehouseReceipt(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplaceWarehouseShipment(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplacePostedWarehouseReceipt(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure ReplacePostedWarehouseShipment(var DefaultReportSelection: Record "ForNAV Report Selection Hist.")
    begin
    ...
    local procedure SaveHistory(Origin: Integer; Usage: Integer; ReportID: Variant; Sequence: Variant)
    var
        ReportSelectionHist: Record "ForNAV Report Selection Hist.";
    begin
        if Origin = 77 then
            ReportSelectionHist.SetRange(Usage, Usage)
        else
            ReportSelectionHist.SetRange("Usage (Warehouse)", Usage);

        ReportSelectionHist.SetRange(Origin, Origin);
        if not ReportSelectionHist.IsEmpty then
            exit;
    ...
    local procedure DeleteExisting(var ReportSelections: RecordRef)
    begin
