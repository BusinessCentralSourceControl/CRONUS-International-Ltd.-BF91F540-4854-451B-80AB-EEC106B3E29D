Codeunit 6188498 "ForNAV Order License"
{
    ...
    begin
        ...
        if LicenseSku.FindSet then
            repeat
                BodyText += LicenseSku.SKU + ' : ' + Format(LicenseSku.Units);
    ...
    local procedure InitLicenseData(var LicenseSku: Record "ForNAV License SKU")
    begin
        LicenseSku.AddDataFromQuery();
    end;

    local procedure CRLF() ReturnValue: Text
    begin
        ReturnValue[1] := 10;
        ReturnValue[2] := 13;
