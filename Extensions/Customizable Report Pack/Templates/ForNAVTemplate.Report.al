...
{	
	...
	{
		type(ForNav.Report_6_0_0_2078; ForNavReport6188998_v6_0_0_2078){}   
	}
...
{
	Caption = 'Template';
	RDLCLayout = './Layouts/ForNAV Template.rdlc'; DefaultLayout = RDLC;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport6188998_v6_0_0_2078;
