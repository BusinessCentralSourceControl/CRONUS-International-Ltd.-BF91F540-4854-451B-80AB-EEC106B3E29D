Codeunit 6188771 "ForNAV Test Void Check"
{
    ...
    var
        Text000Err: label 'Preview is not allowed.', Comment = 'DO NOT TRANSLATE';
    ...
    begin
        ...
        if (GenJnlLn.GetFilter(GenJnlLn."Line No.") <> '') or (GenJnlLn.GetFilter(GenJnlLn."Document No.") <> '') then
            Error(
              Text002Err, GenJnlLn.FieldCaption(GenJnlLn."Line No."), GenJnlLn.FieldCaption(GenJnlLn."Document No."));
