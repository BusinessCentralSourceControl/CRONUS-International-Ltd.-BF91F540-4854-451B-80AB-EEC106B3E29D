Table 6188773 "ForNAV Stub"
{
    ...
    begin
        ...
        then begin
            ...
            LineAmount2 :=
              Round(
                -ExchangeAmt(VendLedgEntry2."Posting Date", "Currency Code", CurrencyCode2, VendLedgEntry2."Amount to Apply"), Currency."Amount Rounding Precision");

            if ApplyMethod <> Check."Application Method"::OneLineID then
                if Abs(RemainingAmount2) < Abs(LineAmount2) then
                    LineAmount2 := RemainingAmount2;

            Amount :=
              Round(ExchangeAmt(VendLedgEntry2."Posting Date", CurrencyCode2, "Currency Code", LineAmount2), Currency."Amount Rounding Precision");
        end;
        Insert;
    end;
