        ...
        area(processing)
        {
            ...
            group("Delete Visuals")
            {
                ...
                action(DeleteWatermark)
                {
                    ...
                    begin
                        if not Confirm(AreYouSureQst, false, Rec.FieldCaption(Watermark)) then
                            exit;
                ...
                action(DeleteSignature)
                {
                    ...
                    var
                        AreYouSureQst: label 'Are you sure you want to clear %1?';
                    begin
                        if not Confirm(AreYouSureQst, false, Rec.FieldCaption(Signature)) then
                            exit;
                ...
                action(Delete2ndSignature)
                {
                    ...
                    var
                        AreYouSureQst: label 'Are you sure you want to clear %1?';
                    begin
                        if not Confirm(AreYouSureQst, false, Rec.FieldCaption("2nd Signature")) then
                            exit;
