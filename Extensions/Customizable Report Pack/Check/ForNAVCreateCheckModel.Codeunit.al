Codeunit 6188775 "ForNAV Create Check Model"
{
    ...
    begin
        ...
        Stub.FindSet;
        repeat
            CreateModelFromStub(Stub, Model, NextLineNo, RunningTotal);
            UpdateModelWithCheck(Check, Model);
        until (Stub.Next = 0) or (CheckSetup.Layout = CheckSetup.Layout::"3 Checks");

    end;

    local procedure CreateModelFromStub(var Stub: Record "ForNAV Stub"; var Model: Record "ForNAV Check Model"; var NextLineNo: Integer; var RunningTotal: Decimal)
    begin
    ...
    local procedure CreateEmptyLinesInStub(var Model: Record "ForNAV Check Model"; var NextLineNo: Integer; StubCount: Integer)
    var
        CheckSetup: Record "ForNAV Check Setup";
    begin
        CheckSetup.Get;
