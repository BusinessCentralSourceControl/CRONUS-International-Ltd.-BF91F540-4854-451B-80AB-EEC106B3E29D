    ...
    begin
        ...
        if Check."Check No." <> GenJnlLine."Document No." then begin
            ...
            if GenJnlLine3.Find('-') then
                GenJnlLine3.FieldError("Document No.", StrSubstNo(Text013, Check."Check No."));
        end;
        ...
        if Check."Application Method" <> Check."application method"::MoreLinesOneEntry then begin
            ...
            if BalancingType <> Balancingtype::"G/L Account" then
                GenJnlLine3.Description := StrSubstNo(Text014, SelectStr(BalancingType + 1, Text062), Check."Balancing No.");
