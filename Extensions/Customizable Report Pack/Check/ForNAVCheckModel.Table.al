Table 6188774 "ForNAV Check Model"
{
    ...
    keys { key(Key1; "Page No.", "Part No.", "Line No.") { } }
    ...
    begin
        CheckSetup.Get;
        case CheckSetup.Layout of
            CheckSetup.Layout::"3 Checks":
                "New Page" := "Part No." = 3;
            CheckSetup.Layout::"Top Check with one Stub":
                "New Page" := "Part No." = 2;
            CheckSetup.Layout::"Bottom Check with one Stub":
                "New Page" := "Part No." = 2;
            CheckSetup.Layout::"Check-Stub-Stub":
                "New Page" := "Part No." = 3;
            CheckSetup.Layout::Other:
                CheckSetup.FieldError(Layout);
            CheckSetup.Layout::"Stub-Check-Stub":
                "New Page" := "Part No." = 3;
            CheckSetup.Layout::"Stub-Stub-Check":
                "New Page" := "Part No." = 3;
        end;
    end;
    ...
    var
        CreateMICRString: Codeunit "ForNAV Create MICR String";
        Handled: Boolean;
    begin
    ...
    begin
        CheckSetup.Get;
        if CheckSetup."No. of Lines (Stub)" = 0 then
            "No. of Pages" := 1
        else
