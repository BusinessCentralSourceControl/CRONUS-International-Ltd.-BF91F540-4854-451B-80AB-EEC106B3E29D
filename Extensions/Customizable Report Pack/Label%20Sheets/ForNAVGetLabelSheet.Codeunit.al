...
{
    procedure GetLabels(var LabelSheetArgs: Record "ForNAV Label Sheet Args."; var LabelSheet: Record "ForNAV Label Sheet")
    var
        GetLabelFilters: Codeunit "ForNAV Get Label Filters";
        RecRef: RecordRef;
    begin
    ...
    local procedure MoveRecRefToLabel(var LabelSheetArgs: Record "ForNAV Label Sheet Args."; var LabelSheet: Record "ForNAV Label Sheet"; var RecRef: RecordRef)
    var
    ...
    begin
        ...
        if RecRef.FindSet then
            repeat
                for i := 1 to LabelSheetArgs."No. of Labels" do begin
                    CreateNewRowIfFirst(LabelRecRef, i = 1);
                    GetNoValueFromRecRef(i, RecRef, LabelRecRef);
                    if RecRef.Next(1) = 0 then
                        i := LabelSheetArgs."No. of Labels";
                end;
    ...
    local procedure TestRecRef(var LabelSheetArgs: Record "ForNAV Label Sheet Args.")
    var
        Fld: Record "Field";
    begin
    ...
    local procedure GetNoValueFromRecRef(LabelNo: Integer; var RecRef: RecordRef; var LabelRecRef: RecordRef)
    var
        Fld: Record "Field";
    ...
    begin
        ...
        if Fld.FindSet then
            repeat
                SourceTableFld.SetRange(TableNo, RecRef.Number);
    ...
    local procedure CreateNewRowIfFirst(var LabelRecRef: RecordRef; First: Boolean)
    var
        FldRef: FieldRef;
        i: Integer;
    begin
