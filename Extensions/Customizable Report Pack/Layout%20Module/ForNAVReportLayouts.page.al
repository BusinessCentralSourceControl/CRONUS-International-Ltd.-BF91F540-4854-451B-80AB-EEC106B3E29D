page 6188483 "ForNAV Report Layouts"
{
    ...
    layout
    {
        area(Content)
        {
            repeater(List)
            {
                field("Report ID"; Rec."Report ID") { ApplicationArea = All; Visible = false; }
                field(Name; Rec.Name) { ApplicationArea = All; }
                field("Custom Report Layout Code"; Rec."Custom Report Layout Code") { ApplicationArea = All; }
                field(Description; Rec.Description) { ApplicationArea = All; }
                field("Last Modified"; Rec."Last Modified") { ApplicationArea = All; }
                field("Last Modified By User"; Rec."Last Modified By User") { ApplicationArea = All; }
