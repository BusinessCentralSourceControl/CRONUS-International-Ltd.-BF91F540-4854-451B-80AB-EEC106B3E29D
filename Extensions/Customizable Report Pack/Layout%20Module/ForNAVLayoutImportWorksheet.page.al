    ...
    layout
    {
        area(Content)
        {
            ...
            repeater(List)
            {
                ...
                field("Custom Layout Code"; Rec."Custom Layout Code") { ApplicationArea = All; }
                field("Import Action"; Rec."Import Action") { ApplicationArea = All; }
                field("Report Exists"; Rec."Report Exists") { ApplicationArea = All; }
                field("Existing Report Name"; Rec."Existing Report Name") { ApplicationArea = All; }
            }
            group(Explanation)
            {
                Caption = 'Actions';
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(Import)
            {
                ...
                trigger OnAction()
                var
                    ExecuteImport: Codeunit "ForNAV Report Layout Import";
                begin
