codeunit 6188503 "ForNAV Report Layout Export"
{
    ...
    begin
        ...
        repeat
            GetLayoutBlob(ReportLayout."Custom Report Layout Code", TempBlob);
    ...
    local procedure GetJsonToBlob(var ReportLayout: Record "ForNAV Report Layout"; var TempBlob: Codeunit "Temp Blob"; var Layouts: List of [Text]);
    var
        OutStr: OutStream;
        JsonArr: JsonArray;
        JsonObj: JsonObject;
    ...
    begin
        ReportLayout.FindSet;
        repeat
            if Layouts.Contains(ReportLayout."Custom Report Layout Code") then begin
            Clear(JsonObj);
    ...
    local procedure GetCsvToBlob(var ReportLayout: Record "ForNAV Report Layout"; var TempBlob: Codeunit "Temp Blob"; var Layouts: List of [Text]);
    var
    ...
    local procedure GetLayoutBlob(Code: Code[20]; var TempBlob: Codeunit "Temp Blob")
    var
    ...
    local procedure CreateZip(var DataCompression: Codeunit "Data Compression")
    begin
        DataCompression.CreateZipArchive();
    end;

    local procedure AddLayoutToZip(Value: Text; var DataCompression: Codeunit "Data Compression"; var TempBlob: Codeunit "Temp Blob")
    var
        InStr: InStream;
    begin
        TempBlob.CreateInStream(InStr);
    ...
    local procedure WriteZip(var DataCompression: Codeunit "Data Compression"; var TempBlob: Codeunit "Temp Blob")
    begin
