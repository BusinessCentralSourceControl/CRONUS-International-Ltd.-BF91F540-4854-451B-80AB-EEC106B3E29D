Table 6188671 "ForNAV Label"
{
    ...
    fields
    {
        ...
        field(6188471; "ForNAV Design"; Boolean) { Caption = 'Design', Comment = 'DO NOT TRANSLATE'; DataClassification = SystemMetadata; }
        field(6188472; "ForNAV Label No."; Integer) { Caption = 'Label No.', Comment = 'DO NOT TRANSLATE'; DataClassification = SystemMetadata; }
        field(6188473; "ForNAV Page No."; Integer) { Caption = 'Page No.', Comment = 'DO NOT TRANSLATE'; DataClassification = SystemMetadata; }
    }
