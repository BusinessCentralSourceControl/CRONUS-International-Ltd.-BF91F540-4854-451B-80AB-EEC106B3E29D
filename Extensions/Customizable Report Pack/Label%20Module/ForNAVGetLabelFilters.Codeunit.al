Codeunit 6188684 "ForNAV Get Label Filters"
{
    ...
    procedure GetFiltersForRecRef(var RecRef: RecordRef)
    var
    ...
    local procedure AddFirstThreeFields(var MyFilterPageBuilder: FilterPageBuilder;var RecRef: RecordRef)
    var
        Fld: Record "Field";
        i: Integer;
    begin
        Fld.SetRange(TableNo, RecRef.Number);
        if Fld.FindSet then repeat
          i += 1;
