codeunit 6188499 "ForNAV Change Service Enpoint"
{
    ...
    local procedure ChangeServiceEndpoint(CurrFieldNo: Integer; var Rec: Record "ForNAV Setup"; var xRec: Record "ForNAV Setup");
    var
    ...
    local procedure ChangeEndpointSettings(CurrFieldNo: Integer; var Rec: Record "ForNAV Setup"; var xRec: Record "ForNAV Setup");
    var
        CoreSetup: Record "ForNAV Core Setup";
    begin
        if not CoreSetup.get then begin
