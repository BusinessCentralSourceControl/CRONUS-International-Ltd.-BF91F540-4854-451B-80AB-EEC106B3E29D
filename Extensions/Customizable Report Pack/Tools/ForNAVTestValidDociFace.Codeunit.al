Codeunit 6188551 "ForNAV Test Valid Doc iFace"
{
    ...
    var
        NotValidTableErr: label 'This table (%1) is not supported for this function.', Comment = 'DO NOT TRANSLATE';
        IsHandled: Boolean;
    begin
    ...
    local procedure OnBeforeCheckValid(var RecRef: RecordRef; var IsHandled: Boolean)
    begin
    end;
}
