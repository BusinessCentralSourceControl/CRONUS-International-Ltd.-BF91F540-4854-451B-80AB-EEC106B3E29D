Codeunit 6188472 "ForNAV Get Vat Amount Lines"
{
    ...
    begin
        if DocLineBuffer.FindSet then
            repeat
                VATAmountLine.Init;
                VATAmountLine."VAT Identifier" := DocLineBuffer."VAT Identifier";
                VATAmountLine."VAT Calculation Type" := "Tax Calculation Type".FromInteger(DocLineBuffer."VAT Calculation Type");
                ...
                if DocLineBuffer."Allow Invoice Disc." then
                    VATAmountLine."Inv. Disc. Base Amount" := DocLineBuffer."Line Amount";
                ...
                if (DocLineBuffer."VAT Clause Code" <> '') or (DocLineBuffer.Amount <> DocLineBuffer."Amount Including VAT") then
