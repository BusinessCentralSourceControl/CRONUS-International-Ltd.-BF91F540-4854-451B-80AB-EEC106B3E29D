...
{
    procedure GetForNAVReports(var Reports: Record "ForNAV Reports")
    var
    ...
    begin
        ...
        if ReportObject.FindSet then
            repeat
                CreateRecord(ReportObject, Reports);
    ...
    local procedure CreateRecord(var ReportObject: Record "ForNAV Report Object"; var Reports: Record "ForNAV Reports")
    var
    ...
    begin
        ...
        if Reports.IsValidForLocalization(Reports.ID) and Reports.ShowReportInList then
            Reports.Insert;
