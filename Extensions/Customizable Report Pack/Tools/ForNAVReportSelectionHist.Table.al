Table 6188478 "ForNAV Report Selection Hist."
{
    ...
    begin
        case Origin of
            Database::"Report Selections":
                CreateReportSelections("Report ID");
            Database::"Report Selection Warehouse":
                CreateReportSelectionsWarehouse("Report ID");
        end;
    end;
    ...
    local procedure CreateReportSelectionsWarehouse(ReportID: Integer)
    var
    ...
    begin
        ...
        ReportSelectionWarehouse.Usage := ("Usage (Warehouse)");
