Table 6188479 "ForNAV Report Selection"
{
    ...
    procedure ReplaceReport()
    begin
    end;

    procedure GetDefaults(var ReportSelectionHist: Record "ForNAV Report Selection Hist.")
    var
    ...
    local procedure SetSource()
    begin
        case "Report ID" of
            1 .. 49999, 99000000 .. 99000999:
                Source := Source::Microsoft;
            50000 .. 99999:
                Source := Source::Custom;
            6188471 .. 6189470:
                Source := Source::ForNAV;
            else
                Source := Source::Other;
        end;
    end;
    ...
    local procedure CreateReportSelections(ReportID: Integer)
    var
    ...
    procedure GetUsage(): Text
    begin
        if Origin = Database::"Report Selections" then
            exit(Format(Usage));

        exit(Format("Usage (Warehouse)"));
    end;

    procedure ReplaceReportsWithForNAV()
    var
    ...
    procedure ResetToMicrosoftDefault()
    var
        ForNAVReportSelectionHist: Record "ForNAV Report Selection Hist.";
        ReportSelections: Record "Report Selections";
