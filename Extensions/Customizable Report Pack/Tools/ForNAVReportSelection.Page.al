Page 6188479 "ForNAV Report Selection"
{
    ...
    actions
    {
        area(processing)
        {
            ...
            action("Restore All")
            {
                ...
                trigger OnAction()
                var
                    RestoreReportSelect: Codeunit "ForNAV Restore Report Select.";
                begin
    ...
    begin
        ...
        if RepSelBuffer.FindSet then
            repeat
                if RepSelBuffer.Origin = 77 then begin
                    ...
                    if ReportSelections.FindFirst then begin
                        ...
                        if ReportSelectionHist.FindFirst then
                            Rec."Original Report ID" := ReportSelectionHist."Report ID";
                        Rec.Origin := 77;
                        Rec.Insert(true);
                    end;
                end else begin
